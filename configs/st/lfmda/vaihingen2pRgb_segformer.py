...
import ever as er
from configs.TOPotsdam_Rgb import EVAL_DATA_CONFIG, PSEUDO_DATA_CONFIG, TEST_DATA_CONFIG, \
    TARGET_SET,DATASETS, DATA_ROOT_TGT, target_dir
...
PRETRAINED_TEACHER = '/home/yons/.cache/torch/hub/checkpoints/dinov2_vitl14_pretrain.pth'
# student cfg
...
SNAPSHOT_DIR = f'./log/hyperdaseg/{MODEL_STUDENT}_{BACKBONE_STUDENT}/vaihingen2pRgb'
