...
# PRETRAINED_TEACHER = ('/home/yons/文档/论文/HyperDASeg/ck'
#                       'pts/backbones/dinov3-vitl16-pretrain-lvd1689m')
# # student cfg
# MODEL_STUDENT = 'SegFormer'
# BACKBONE_STUDENT = 'MiT-B2'
# # PRETRAINED_STUDENT = None
...
SNAPSHOT_DIR = f'./log/hyperdaseg/{MODEL_STUDENT}_{BACKBONE_STUDENT}/2vaihingen'
