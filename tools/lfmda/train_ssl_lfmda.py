...
from hyperdaseg.gast.pseudo_generation_hyperdaseg import gener_target_pseudo, pseudo_selection
    ...
    for i_iter in tqdm(range(stop_steps)):
        ...
        if i_iter == 0 or i_iter == stop_steps // 2:
            if args.gen:
                ...
                gener_target_pseudo(cfg, model_tea if args.tea_gen else model_stu, pseudo_loader, save_pseudo_label_path,
